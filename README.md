...
This project is focused on revealing the main insights and the trends of profitability through the analysis of the sales data of an E-Commerce company. The exploration of the dataset carried out by means of the Pandas and Plotly libraries led to the identification of the best months, product categories, and customer segments.

---

## **Objectives**

1. Analyze monthly sales and identify the highest and lowest months.
2. Evaluate sales and profit by product category and sub-category.
3. Compare monthly profit trends.
...
## **Conclusion**
- Tech products and corporate customers generate the highest profit.
